...
The **Inventory** table stores the current stock quantity of every product variant available at each Vovers store and warehouse.

Each record represents the available quantity of a specific product variant at a particular inventory location. This table supports inventory tracking, stock movement, replenishment planning, warehouse operations, and inventory analytics.
